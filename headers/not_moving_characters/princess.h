...
#ifndef ROGUELIKE_CMAKE_BUILD_DEBUG_HEADERS_NOT_MOVING_CHARACTERS_PRINCESS_H_
#define ROGUELIKE_CMAKE_BUILD_DEBUG_HEADERS_NOT_MOVING_CHARACTERS_PRINCESS_H_
...
#endif //ROGUELIKE_CMAKE_BUILD_DEBUG_HEADERS_NOT_MOVING_CHARACTERS_PRINCESS_H_

...
#ifndef ROGUELIKE_CMAKE_BUILD_DEBUG_HEADERS_MOVING_CHARACTERS_DRAGON_H_
#define ROGUELIKE_CMAKE_BUILD_DEBUG_HEADERS_MOVING_CHARACTERS_DRAGON_H_
...
#endif //ROGUELIKE_CMAKE_BUILD_DEBUG_HEADERS_MOVING_CHARACTERS_DRAGON_H_
